...
//***Step 8a) Remove --signal inputValue
//***- Delete the text "--sinal inputValue" from the Previous automation below
//***- Run Arctic Fox
//***- Notice that result is the same, and the automation was less verbose  
/*[Previous]*/
reg p1_inputValue;
...
//***Step 8b) Again, remove --signal p1_inputValue
//***- Delete the text "--sinal p1_inputValue" from the Previous automation below
//***- Run Arctic Fox
//***- Notice that result is the same, and the automation was less verbose  
/*[Previous]*/
reg p2_inputValue;
...
//S***Run and Clean
//***By t_his point, you are likely familiar with running Arctic Fox. Additionally, you can use the 
//***clean function which will remove all generated code. First, let's run Arctic Fox, and then 
//***perform a clean to see generated code be removed. 
//_***Step 9a) Run and Clean
//_***- Open the Arctic Fox pane on the left
//_***- Press the Run button, observe the generated code
//_***- Press the Clean button, observe the generated code is removed



//S***Run and Clean Shortcuts
//***Using the GUI is effective but we know that someone people want to run Arctic Fox faster. To 
//***make t_his possible, we created keyboard shortcuts. To run Arctic Fox, you can press alt + x, 
//***(the + means press the others together, you do not press the plus key). To clean Arctic Fox, 
//***you can press alt + c. 
//_***Step 9b) Run and Clean With Keyboard Shortcut
//_***- Press alt + x to run Arctic Fox, observe the generated code
//_***- Press alt + c to clean Arctic Fox, observe the generated code is removed



//_***Continue to Step10_Conclusion
