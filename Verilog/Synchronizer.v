...
//_***Step 5a) Add a Clock automation on the line below, right above input clk
//_***- Press alt + a
//_***- Type "Clock 100MHz" between the automation brackets
...
//_***Step 5b) Add a Reset None automation on the line below
//_***- Press alt + a
//_***- Type "Reset None" between the automation brackets
...
//_***Step 5c) Add a Previous automation on the line below and a p1_inputValue reg after that 
//_***- Press alt + a
//_***- In the automation brackets, type "Previous --signal inputValue"
//_***- On the line after the automation, type reg p1_inputValue;
//_***- Run Arctic Fox, you should see code generated after p1_inputValue
//_***doc:https://tinyurl.com/af-previous

//_***Continue to Step6_CompleteSynchronizer
