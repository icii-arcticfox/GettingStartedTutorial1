...
//***generated code. 
//_***Step 7a) Change Reset None to a Reset signal
//_***- Remove the word None from the Reset automation below
//_***- Type "input reset," on the line after the Reset automation
//_***- Run Arctic Fox
//_***- Look at the generated code below in Steps 7b) and 7c), note the included reset signal
...
//_***Step 7b) Notice the reset signal used below
...
//_***Step 7c) Notice the reset signal used below
/*[Previous --signal p1_inputValue]*/
reg p2_inputValue;


//_***Continue to Step8_PreviousWithNoItems
