...
//_***Step 6a) Add a second Previous automation
//_***- Press alt + a
//_***- In the automation brackets, type "Previous --singal p1_inputValue"
//_***- On the line after the automation, type reg p2_inputValue;
//_***- Run Arctic Fox to generate the code for p2_inputValue
...
//_***Step 6b) Assign synchronizedOutput
//_***- On the line below, type "assign synchronizedOutput = p2_inputValue;"  



//_***Continue to Step7_IncludeReset
